...
def fit(df, num_of_fuzzy_clusters=2, fuzzy_factor=1.5):
    global NUM_OF_CLUSTER, FUZZY_FACTOR, TERMINATION_THRESHOLD, OUTPUT_DIR
    NUM_OF_CLUSTER = num_of_fuzzy_clusters
...
if __name__ == "__main__":
    ...
    # Allocating memory
    inputs = sys.argv[1]
    df = pd.read_csv(inputs, header=None)
    x = df.values.tolist()
    # print(x)
    n, d = df.shape
    E = TERMINATION_THRESHOLD
